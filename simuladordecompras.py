...
if quantidade > 2: #verificando se a quantidade é maior que 2
    valor_total = valor_total * 0.8 #aplicando o desconto de 10% ao valor total

print("Produto:", produto) #exibindo o nome do produto
print('quantidade comprada:', quantidade) #exibindo a quantidade comprada
print(f"Valor total da compra: R${valor_total:.2f}") #exibindo o valor total da compra com o desconto aplicado, se houver
